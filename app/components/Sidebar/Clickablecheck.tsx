...
const chipbar = [
{ id: 1, title: "การตรวจสอบสถานะการจองห้อง", link: "/employee/checks" },
{ id: 2, title: "การตรวจสอบสถานะการยืม-คืนเครื่องมือ", link: "/employee/checks/tool" }

]
export default function Clickablecheck() {
